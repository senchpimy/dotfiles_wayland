...
property int animationDuration: 1200 // Duración de la animación en milisegundos

// Elemento principal con animación
Item {
    id: mainContent
    anchors.fill: parent
    ...
    Item {
        ...
        Rectangle {
            anchors.fill: parent
            color: "#20000000" // Overlay oscuro
        }
    }

    // Etiqueta para mostrar el día
    Label {
        id: day
...
// Overlay oscuro para transición
Rectangle {
    id: darkenOverlay
    anchors.fill: parent
    color: "black"
...
Connections {
    target: root.context
    //function onUnlocked() { triggerUnlock() }
}
